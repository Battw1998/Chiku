...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Battw1998/Chiku/blob/main/Approved.txt').text
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Battw1998/Chiku/blob/main/Approved.txt').text
    if id in httpCaht:
      print(fuckyoursali)
